...
public class PropertyInfo {
    ...
    protected static HashMap<String, String> PROP_MAP = new HashMap<String, String>();
    ...
    protected PropertyInfo() {
        ...
        Collections.list(bundle.getKeys()).forEach(key -> {
            ...
            logger.info(Util.getClassName() + Util.CM_SEP + Util.getMethodName() + ":[" + bundle.getBaseBundleName() + "]から、key=[" + key + "], value=[" + value + "]を取得しました。");
        });
    ...
    public static PropertyInfo getInstance() {
        ...
        if(PROP_DEF == null) {
            ...
            logger.info(Util.getClassName() + Util.CM_SEP + Util.getMethodName() + ":" + METHOD_OVERVIEW + ":PROP_DEFのinstanceを生成しました。");
        } else {
            logger.info(Util.getClassName() + Util.CM_SEP + Util.getMethodName() + ":" + METHOD_OVERVIEW + ":PROP_DEFのinstanceは生成済みです。");
        }
    ...
    public String getValue(String key) {
        ...
        if(PROP_MAP.containsKey(key)) {
            ...
            logger.info(Util.getClassName() + Util.CM_SEP + Util.getMethodName() + ":" + METHOD_OVERVIEW + ":key=[" + key + "], value=[" + value + "]");
        } else {
            logger.info(Util.getClassName() + Util.CM_SEP + Util.getMethodName() + ":" + METHOD_OVERVIEW + ":mvn-web-appに[" + key + "]は存在しません。");
        }
